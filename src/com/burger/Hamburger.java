...
public class Hamburger extends Burger implements IExtraIngredientAddible{

    private eExtraIngredient[] extraIngredients;
    private int idxNextExtraIngredient;
    final static private int maxCntIngredient = 4;

    public Hamburger(String name, String meat, double price, eBreadRollType breadRollType ) {
